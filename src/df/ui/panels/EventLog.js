(() => {
  ...
  DF.EventLog=({log,onPromptChoice})=>{
    ...
    return h("div",{className:"df-log-panel"},
      h("div",{className:"df-log-panel__header"},
        h("div",{className:"df-log-panel__title"},"Event Log"),
        h("div",{className:"df-log-panel__subtitle"},"Newest entries first")
      ),
      h("div",{className:"df-log-panel__body"},
        (!lines||lines.length===0)?h("div",{className:"df-log-empty"},"No events yet."):
        lines.map(l=>{
