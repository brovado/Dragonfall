(() => {
  DF.mkNewGame=(seed=Date.now())=>{
    ...
    return {version:DF.VERSION,gameId,rngSeed,phase:"start",screen:"PrepScreen",book:{chapter:1,page:1},
      ...
      ui:{showPromotion:false,selectedNode:null,travelOpen:false,menuOpen:false,sidebarCollapsed:false,promptedWeapon:false,promptedStyle:false,scene:DF.SCENES?.TITLE||"TITLE",screen:DF.UI_SCREENS?.TITLE||"TITLE",scenePayload:null}
    };
  };
})();
